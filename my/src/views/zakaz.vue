                    ...
                    <form action="/">
                        <div class="row">
                            <div class="col-50">
                                ...
                                <input type="text" id="email" name="email" placeholder="ioan@example.com">
                                <label for="adr"><i class="fa fa-address-card-o"></i> Адрес</label>
                                <input type="text" id="adr" name="address" placeholder="ул. Иванаова, д.5, кв. 6.">
                                <label for="city"><i class="fa fa-institution"></i> Город</label>
                                <input type="text" id="city" name="city" placeholder="Белгород">

                                <div class="row">
                                    <div class="col-50">
                                        <label for="zip">Индекс</label>
                                        <input type="text" id="zip" name="zip" placeholder="308605">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-50">
                                <h3>Предоплата</h3>
                                <label for="fname">Данные электронной карты</label>
                                ...
                                <label for="cname">Имя держателя</label>
                        ...
                        <label>
                            <input type="checkbox" checked="checked" name="sameadr"> Платежный адрес такой же, как и адрес доставки
                        </label>
